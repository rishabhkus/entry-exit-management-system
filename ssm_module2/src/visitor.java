...
public class visitor extends javax.swing.JFrame {
 ...
 String uid=a[1],pass=a[2];
               ...
               stmt.executeQuery("use ssm1");
                    ...
                    tb.setRowCount(0);
                    while(rs.next()){
                        String verified,vehicle,status;
                        ...
                        if(rs.getBoolean(10)==true)
                            ...
                            if(rs.getBoolean(13)==true)
                                ...
                                status="OUT";
                    tb.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3),verified,rs.getBigDecimal(5),rs.getString(8),rs.getString(7),vehicle,rs.getString(11),rs.getString(12),status});
                    }}
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Id-Submitted", "Verified", "Phone", "Reference", "Purpose", "Vehicle", "V-Type", "V-Number", "Status"
            }
        ) {
